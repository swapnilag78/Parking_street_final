  ...
  <span class="border">
    <section class=my-5">
      <div class="mr-5 mx-5">
        ...
        <div class="form-group">
          <label for="floor">Active Floor</label>
          <input type="number" class="form-control" name="florr" placeholder="">
        </div>
      ...
      <span class="border">
        <section class="">
          <div class="mr-5 mx-5">
            ...
            <div class="form-group">
              <label for="floor">Active Floor</label>
              <input type="number" class="form-control" name="floor" placeholder="">
            </div>
            <div class="form-group">
              <label for="floor">Active Floor</label>
              <input type="number" class="form-control" name="floor" placeholder="">
        ...
        <span class="border">
          <section class="">
            <div class="mr-5 mx-5">
              <h2> Updating Parking Lot Status</h2>
              <div class="form-group">
                <label for="floor">LICENCE PLATE NUMBER</label>
                <input type="text" class="form-control" name="floor" placeholder="">
              </div>
            </div>
          </section>
